 ...
 *
 *=========================================================================*/
#ifndef __elxMultiInputRandomCoordinateMoranSampler_h
#define __elxMultiInputRandomCoordinateMoranSampler_h
...
/**
 * \class MultiInputRandomCoordinateMoranSampler
 * \brief An interpolator based on the itk::MultiInputImageRandomCoordinateMoranSampler.
 *
 * This image sampler randomly samples 'NumberOfSamples' coordinates in the InputImageRegion,
 * which selected via Moran's I test. A mask is not suggestibly needed due to non-structure
 * detection. The MultiInputRandomCoordinate sampler samples not only positions that correspond
 ...
 *
 * Compared to the elx::RandomCoordinateSampler this sampler takes into account the image 
 * regions and masks of multiple input images by Moran's I test. Thus, only samples are 
 * selected that lie within all input images. This is useful when using the
 ...
 *    <tt>(ImageSampler "MultiInputRandomCoordinateMoran")</tt>
...
class MultiInputRandomCoordinateMoranSampler :
  public
  itk::MultiInputImageRandomCoordinateMoranSampler<
...
public:
  ...
  /** Standard ITK-stuff. */
  typedef MultiInputRandomCoordinateMoranSampler Self;
  typedef itk::MultiInputImageRandomCoordinateMoranSampler<
  ...
  itkTypeMacro( MultiInputRandomCoordinateMoranSampler, MultiInputImageRandomCoordinateMoranSampler );

  /** Name of this class.
   * Use this name in the parameter file to select this specific interpolator. \n
   * example: <tt>(ImageSampler "MultiInputRandomCoordinateMoran")</tt>\n
   */
  elxClassNameMacro( "MultiInputRandomCoordinateMoran" );
...
protected:
  ...
  /** The constructor. */
  MultiInputRandomCoordinateMoranSampler() {}
  /** The destructor. */
  virtual ~MultiInputRandomCoordinateMoranSampler() {}

private:

  /** The private constructor. */
  MultiInputRandomCoordinateMoranSampler( const Self & );  // purposely not implemented
...
#include "elxMultiInputRandomCoordinateMoranSampler.hxx"
#endif

#endif // end #ifndef __elxMultiInputRandomCoordinateMoranSampler_h
