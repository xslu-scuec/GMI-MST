...
public:
  ...
  typedef typename EdgeContainerType::Pointer        EdgeContainerPointer;
  ...
  NodePointerType GetNodePointer( NodeIdentifierType Id )
    {
    return const_cast<NodePointerType>
           (&(static_cast<const NodeContainerType *>( this->m_Nodes )->ElementAt( Id )));
    }
  EdgePointerType GetEdgePointer( EdgeIdentifierType Id )
    {
    return const_cast<EdgePointerType>
           (&(static_cast<const EdgeContainerType *>( this->m_Edges )->ElementAt( Id )));
    }
  ...
  /** Sort all edges of m_Edges by weight */
  void EdgeSort( void )
...
private:
  ...
  EdgeContainerPointer m_Edges;
  NodeContainerPointer m_Nodes;
